...
# -------------------------------------------------------------------
# =====> Write your code here
cWord = input("Enter a two letter word ")
cWord = cWord.upper()

for pair in wordTable:
    word = pair[0]
    value = pair[1]

if cWord == word:
    print("Word is found")
    print("Your word",cWord,"has a value of "+value+" points.")

else:
    print("Your word was not found")
    print("You could have chosen",value,"worth "+str(value)+" points.")
